...
#define CAMERA_MODEL_DEFINITIONS(model_id_value, model_name_value,             \
  ...
  static inline std::vector<double> InitializeParams(                          \
      const double focal_length, const size_t width, const size_t height);     \
                                                                               \
  template <typename T>                                                        \
  static void Point3DToWorldPlane(                                             \
...
template <typename T>
void SimplePinholeCameraModel::Point3DToWorldPlane(const T* params, const T x,
...
template <typename T>
void PinholeCameraModel::Point3DToWorldPlane(const T* params, const T x,
                                                   const T y, const T z, T* u,
                                                   T* v) {
  *u = x / z;
  *v = y / z;
...
template <typename T>
void SimpleRadialCameraModel::Point3DToWorldPlane(const T* params, const T x,
                                                   const T y, const T z, T* u,
                                                   T* v) {
  *u = x / z;
  *v = y / z;
...
template <typename T>
void RadialCameraModel::Point3DToWorldPlane(const T* params, const T x,
                                                   const T y, const T z, T* u,
                                                   T* v) {
  *u = x / z;
  *v = y / z;
...
template <typename T>
void OpenCVCameraModel::Point3DToWorldPlane(const T* params, const T x,
                                                   const T y, const T z, T* u,
                                                   T* v) {
  *u = x / z;
  *v = y / z;
...
template <typename T>
void OpenCVFisheyeCameraModel::Point3DToWorldPlane(const T* params, const T x,
                                                   const T y, const T z, T* u,
                                                   T* v) {
  *u = x / z;
  *v = y / z;
...
template <typename T>
void FullOpenCVCameraModel::Point3DToWorldPlane(const T* params, const T x,
                                                   const T y, const T z, T* u,
                                                   T* v) {
  *u = x / z;
  *v = y / z;
...
template <typename T>
void FOVCameraModel::Point3DToWorldPlane(const T* params, const T x,
                                                   const T y, const T z, T* u,
                                                   T* v) {
  *u = x / z;
  *v = y / z;
...
template <typename T>
void SimpleRadialFisheyeCameraModel::Point3DToWorldPlane(const T* params, const T x,
                                                   const T y, const T z, T* u,
                                                   T* v) {
  *u = x / z;
  *v = y / z;
...
template <typename T>
void RadialFisheyeCameraModel::Point3DToWorldPlane(const T* params, const T x,
                                                   const T y, const T z, T* u,
                                                   T* v) {
  *u = x / z;
  *v = y / z;
...
template <typename T>
void ThinPrismFisheyeCameraModel::Point3DToWorldPlane(const T* params, const T x,
                                                   const T y, const T z, T* u,
                                                   T* v) {
  *u = x / z;
  *v = y / z;
...
template <typename T>
void UnifiedCameraModel::Point3DToWorldPlane(const T* params, const T x,
                                                   const T y, const T z, T* u,
                                                   T* v) {
  const T xi = params[8];
...
#define CAMERA_MODEL_CASE(CameraModel)                                  \
  case CameraModel::kModelId:                                           \
    CameraModel::Point3DToWorldPlane(params.data(), u, v, w, &uu, &vv); \
